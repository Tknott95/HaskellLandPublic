...
/* package haskpi-0.1.0.0 */
#ifndef VERSION_haskpi
#define VERSION_haskpi "0.1.0.0"
#endif /* VERSION_haskpi */
#ifndef MIN_VERSION_haskpi
#define MIN_VERSION_haskpi(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskpi */
...
#define CURRENT_COMPONENT_ID "haskpi-0.1.0.0-inplace-haskpi"
